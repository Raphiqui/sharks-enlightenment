...
export const useFactCardsStore = defineStore("factCards", {
  state: () => ({
    factCards: [
      {
        title: "1 in 3.7M",
        content: "Chance of being attacked by a shark.",
      },
      {
        title: "100M",
        content: "Sharks killed by humans each year.",
      },
      {
        title: "400+",
        content: "Species of sharks in the ocean.",
      },
      {
        title: "70%",
        content: "Shark species threatened or endangered",
      },
      {
        title: "Ampullae of Lorenzini",
        content:
          "Allow them to detect the electrical fields generated by other animals.",
      },
      {
        title: "45 miles per hour",
        content: "Speed of the Shortfin Mako shark.",
      },
      {
        title: "Over 400 years old",
        content: "Lifetime of the Greenland shark",
      },
      {
        title: "Dermal denticles",
        content: "Tiny tooth-like structures which covered the shark skin.",
      },
    ],
  }),
});
